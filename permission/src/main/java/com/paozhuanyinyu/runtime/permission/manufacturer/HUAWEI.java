 ...
 * <p>
 * manager permissions page, permissions manage page, or {@link Protogenesis#settingIntent(Context context)}
 * <p>
 */
...
//    private final String SINGLE_TAG = "SingleAppActivity";
    ...
    public Intent settingIntent(Context context) throws ActivityNotFoundException {
        Intent intent = new Protogenesis().settingIntent(context);
